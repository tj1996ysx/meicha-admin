...
@endphp
  ...
  <div data-preview="#{{ $field['name'] }}"
        ...
        @include('backpack.crud.inc.field_wrapper_attributes')>
    <div>
    ...
    <div class="btn-group">
        <label class="btn btn-primary btn-file">
            {{ trans('backpack::crud.choose_file') }} <input type="file" accept="image/*" id="uploadImage"  @include('backpack.crud.inc.field_attributes', ['default_class' => 'hide'])>
