...
<div @include('backpack.crud.inc.field_wrapper_attributes') >
    ...
    @if ($multiple)
        @foreach((array)$value as $v)
            @if ($v)
                <div class="input-group input-group-sm">
                    <input type="text" name="{{ $field['name'] }}[]" value="{{ $v }}" @include('backpack.crud.inc.field_attributes') readonly>
        ...
        @endforeach
    @else
        <input type="text" name="{{ $field['name'] }}" value="{{ $value }}" @include('backpack.crud.inc.field_attributes') readonly>
    @endif
...
<script type="text/html" id="browse_multiple_template_{{ $field['name'] }}">
    <div class="input-group input-group-sm">
        <input type="text" name="{{ $field['name'] }}[]" @include('backpack.crud.inc.field_attributes') readonly>
        <div class="input-group-btn">
            <button type="button" class="browse_{{ $field['name'] }} remove btn btn-default">
                <i class="fa fa-trash"></i>
            </button>
