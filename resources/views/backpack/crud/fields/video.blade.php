...
<div data-video @include('backpack.crud.inc.field_wrapper_attributes') >
    ...
    <div class="input-group">
        <input @include('backpack.crud.inc.field_attributes', ['default_class' => 'video-link form-control']) type="text" id="{{ $field['name'] }}_link">
