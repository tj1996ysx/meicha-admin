...
<script>
    ...
    var crud = {
            ...
            dataTableConfiguration: {
                ...
                dom:
                    "<'row'<'col-sm-4 hidden-xs'l><'col-sm-4 hidden-xs'B><'col-sm-4 hidden-print'f>>" +
                    "<'row'<'col-sm-12'tr>>" +
...
@include('backpack.crud.inc.export_buttons')
...
@include('backpack.crud.inc.details_row_logic')
