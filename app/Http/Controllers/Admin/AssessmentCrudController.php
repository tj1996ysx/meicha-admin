...
class AssessmentCrudController extends CrudController
{
    public function setup()
    {
        ...
        */
        ...
        $this->crud->setRoute(config('backpack.base.route_prefix') . '/assessment');
        $this->crud->setEntityNameStrings('评价', '评价');
...
//        $this->crud->denyAccess(['create', 'delete', 'update']);
        ...
        // add asterisk for fields that are required in AssessmentRequest
